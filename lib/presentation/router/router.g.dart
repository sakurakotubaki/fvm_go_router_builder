...
List<RouteBase> get $appRoutes => [$homeRoute, $nextRoute, $adminRoute];
...
RouteBase get $nextRoute =>
    GoRouteData.$route(path: '/next', factory: $NextRoute._fromState);

mixin $NextRoute on GoRouteData {
  static NextRoute _fromState(GoRouterState state) => const NextRoute();

  @override
  String get location => GoRouteData.$location('/next');
...
String _$routerHash() => r'caccb9961dd7959d9bf7136120f6c199cea99a75';
